  ...
  it('GET /health/detailed reports the launch mode, the timezones and the live gated browsers', async () => {
    const app = build({
      getBrowserLane: () => ({
        ...
        gatedBrowsers: [
          { egress: 'residential', launchedAt: '2026-09-07T12:00:00.000Z', pagesOpen: 1, primedHosts: 2, lastRelaunchAt: null, relaunchCount: 0, relaunchFailures: 0, drainedTabsAtRelaunch: 0, firstNavigationRetries: 0, firstNavigationRecoveries: 0, lastRelaunchReason: null, navFailureStreak: 0, pssMb: null, rssMb: null, memoryMethod: null, memoryThresholdMb: 1024, relaunchSuppressed: 0, lastSuppressedReason: null, nextRelaunchAllowedAt: null, relaunchBackoffMs: 0, carryBlockedHosts: [] },
          { egress: 'direct', launchedAt: '2026-09-07T12:05:00.000Z', pagesOpen: 0, primedHosts: 0, lastRelaunchAt: null, relaunchCount: 0, relaunchFailures: 0, drainedTabsAtRelaunch: 0, firstNavigationRetries: 0, firstNavigationRecoveries: 0, lastRelaunchReason: null, navFailureStreak: 0, pssMb: null, rssMb: null, memoryMethod: null, memoryThresholdMb: 1024, relaunchSuppressed: 0, lastSuppressedReason: null, nextRelaunchAllowedAt: null, relaunchBackoffMs: 0, carryBlockedHosts: [] },
        ],
      }),
    });
  ...
  it('keeps the browserLane view on the degraded (500) response too', async () => {
    const app = build({
      ...
      getBrowserLane: () => ({
        ...
        processTimezone: 'America/Chicago',
        navigationTimeoutMs: 20000,
        gatedBrowsers: [{ egress: 'residential', launchedAt: '2026-09-07T12:00:00.000Z', pagesOpen: 0, primedHosts: 1, lastRelaunchAt: null, relaunchCount: 0, relaunchFailures: 0, drainedTabsAtRelaunch: 0, firstNavigationRetries: 0, firstNavigationRecoveries: 0, lastRelaunchReason: null, navFailureStreak: 0, pssMb: null, rssMb: null, memoryMethod: null, memoryThresholdMb: 1024, relaunchSuppressed: 0, lastSuppressedReason: null, nextRelaunchAllowedAt: null, relaunchBackoffMs: 0, carryBlockedHosts: [] }],
      }),
    });
